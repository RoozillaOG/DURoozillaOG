    ...
    local self = {
      idToDisplayName = {
        [1331181089] = { id = 1331181089, displayNameWithSize = "Advanced hydraulics" },
         ...
         [3936127017] = { id = 3936127017, displayNameWithSize = "Advanced Screw" },
         [3936127019] = { id = 3936127019, displayNameWithSize = "Basic Screw" },
         [3936127018] = { id = 3936127018, displayNameWithSize = "Uncommon Screw" },
      ...
      displayNameToId = {
        ["Advanced hydraulics"] = { id = 1331181089, displayNameWithSize = "Advanced hydraulics" },
         ...
         ["Advanced Screw"] = { id = 3936127017, displayNameWithSize = "Advanced Screw" },
         ["Basic Screw"] = { id = 3936127019, displayNameWithSize = "Basic Screw" },
         ["Uncommon Screw"] = { id = 3936127018, displayNameWithSize = "Uncommon Screw" },
